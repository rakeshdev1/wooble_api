            ...
            if (isset($_POST['email_id'])) {
                try {
                    ...
                    if (base64_decode($image_1) != "NULL") {
                        ...
                        $decode_image_1_name = $image_1_name . ".WEBP";
                    }
                    ...
                    if (base64_decode($image_2) != "NULL") {
                        ...
                        $decode_image_2_name = $image_2_name . ".WEBP";
                    }
                    ...
                    if (base64_decode($image_3) != "NULL") {
                        ...
                        $decode_image_3_name = $image_3_name . ".WEBP";
                    }
                    ...
                    if (base64_decode($image_4) != "NULL") {
                        ...
                        $decode_image_4_name = $image_4_name . ".WEBP";
                    }
                    ...
                    if (base64_decode($image_5) != "NULL") {
                        ...
                        $decode_image_5_name = $image_5_name . ".WEBP";
                    }
                    ...
                    if (base64_decode($image_6) != "NULL") {
                        ...
                        $decode_image_6_name = $image_6_name . ".WEBP";
                    }
                    ...
                    if (base64_decode($video) != "NULL") {
                        ...
                        $decode_video_name = $video_name . ".mp4";
                    }
                    ...
                    if (base64_decode($project_pdf) != "NULL") {
                        ...
                        $decode_project_pdf_name = $project_pdf_name . ".pdf";
                    }

                    $stmt = $conn->prepare("INSERT INTO `works_db`(`work_title`, `work_description`,`email_id`, `added_date`, `image_1`, `image_2`, `image_3`, `image_4`, `image_5`, `image_6`, `video`, `conclusion`, `pdf_file`, `aim_of_work`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                    $stmt->bind_param("ssssssssssssss", $work_title, $work_description, $email_id, $added_date, $decode_image_1_name, $decode_image_2_name, $decode_image_3_name, $decode_image_4_name, $decode_image_5_name, $decode_image_6_name, $decode_video_name, $conclusion, $decode_project_pdf_name, $aim_of_work);
        ...
        case 'updateprojectdata':
            ...
            if (isset($_POST['email_id'])) {
                ...
                try {
                    ...
                    if (startsWith(base64_decode($image_1), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $image_1_name . ".WEBP"))
                        {
                    ...
                    if (startsWith(base64_decode($image_2), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $image_2_name . ".WEBP"))
                        {
                    ...
                    if (startsWith(base64_decode($image_3), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $image_3_name . ".WEBP"))
                        {
                    ...
                    if (startsWith(base64_decode($image_4), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $image_4_name . ".WEBP"))
                        {
                    ...
                    if (startsWith(base64_decode($image_5), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $image_5_name . ".WEBP"))
                        {
                    ...
                    if (startsWith(base64_decode($image_6), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $image_6_name . ".WEBP"))
                        {
                    ...
                    if (startsWith(base64_decode($video), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $video_name . ".mp4"))
                        {
                    ...
                    if (startsWith(base64_decode($project_pdf), $email_id)) {
                        ...
                        if(file_exists(UPLOAD_PATH . $project_pdf_name . ".pdf"))
                        {
        ...
        case 'deleteprojectdata':
            ...
            if (isset($_POST['entry_id']) && isset($_POST['email_id'])) {
                try {
                    ...
                    $stmt = $conn->prepare("SELECT `image_1`, `image_2`, `image_3`, `image_4`, `image_5`, `image_6`, `video`, `pdf_file` FROM `works_db` WHERE entry_id=? AND email_id=?");
                    $stmt->bind_param("ss", $_POST['entry_id'], $_POST['email_id']);
                    $stmt->execute();
                    $stmt->bind_result($image_1, $image_2, $image_3, $image_4, $image_5, $image_6, $video, $pdf_file);
                    $img1;
                    $img2;
                    $img3;
                    $img4;
                    ...
                    if ($img1 != null) {
                        unlink(UPLOAD_PATH . $img1);
                    }
                    if ($img2 != null) {
                        unlink(UPLOAD_PATH . $img2);
                    }
                    if ($img3 != null) {
                        unlink(UPLOAD_PATH . $img3);
                    }
                    if ($img4 != null) {
                        unlink(UPLOAD_PATH . $img4);
                    }
                    if ($img5 != null) {
                        unlink(UPLOAD_PATH . $img5);
                    }
                    if ($img6 != null) {
                        unlink(UPLOAD_PATH . $img6);
                    }
                    if ($vid != null) {
                        unlink(UPLOAD_PATH . $vid);
                    }
                    if ($pdf != null) {
                        unlink(UPLOAD_PATH . $pdf);
                    }
